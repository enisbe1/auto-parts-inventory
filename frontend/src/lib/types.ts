...
export interface Vehicle { id: number; vin?: string; year?: number; mileage?: number; purchasePrice?: number; purchaseDate?: string; status: string; notes?: string; variantId?: number; variant?: Variant; parts?: Part[]; photos?: string[]; createdAt: string; }
export interface Category { id: number; name: string; description?: string; }
export interface Part { id: number; name: string; partNumber?: string; condition: string; price?: number; status: string; notes?: string; vehicleId?: number; vehicle?: Vehicle; categoryId?: number; category?: Category; photos?: string[]; createdAt: string; }
